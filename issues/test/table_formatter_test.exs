defmodule TableFormatterTests do
  use ExUnit.Case
  ...
  test "Output is correct" do
    ...
    # I can't get VS Code to stop trimming trailing whitespace
    # in heredocs. I resorted to formatting it this way even though the code
    # is uglier.
    assert result ==
             "c1    | c2     | c4     \n" <>
               "------+--------+--------\n" <>
